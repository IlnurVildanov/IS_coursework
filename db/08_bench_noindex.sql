...
DROP INDEX IF EXISTS ix_doctors_active;
DROP INDEX IF EXISTS ix_doctor_specialties_specialty;
DROP INDEX IF EXISTS ix_doctor_services_service;
DROP INDEX IF EXISTS ix_slots_doctor_start_free;
DROP INDEX IF EXISTS ix_appointments_patient_created;
DROP INDEX IF EXISTS ix_appointments_doctor_slot;
DROP INDEX IF EXISTS ix_slots_start;
DROP INDEX IF EXISTS ix_notifications_user_unread;
DROP INDEX IF EXISTS ix_audit_events_brin_time;
DROP INDEX IF EXISTS ix_pharmacy_log_brin_time;

DROP INDEX IF EXISTS ix_facilities_type_active;
DROP INDEX IF EXISTS ix_facility_addresses_current;
DROP INDEX IF EXISTS ix_lab_orders_patient_requested;
DROP INDEX IF EXISTS ix_lab_orders_performer_status_time;
DROP INDEX IF EXISTS ix_lab_transfers_to_status_time;
DROP INDEX IF EXISTS ix_lab_results_item_time;
